...
public class Clienttester {
    ...
    static Integer[] expTable = new Integer[140];
    ...
    static String []  sendMessage(String message) {
        ...
        switch (s[0]) {
            ...
            case "newroom":
                 ...
                 */
                // Roomを作成しリストに追加
                newRoom = new Room(s[1], Integer.parseInt(s[2]), myInfo.getId(), myInfo.getName());
...
//                });
    ...
    static String [] receiveMessage(String message) {
